...
export default function App() {
  ...
  // Demo content
  const demoText = `
The Mitochondria is often referred to as the "powerhouse of the cell". It is a 
double-membrane-bound organelle found in most eukaryotic organisms. Some cells in some 
multicellular organisms may lack mitochondria (for example, mature mammalian red blood cells).
The outer membrane describes the organelle's surface, while the inner membrane contains folds c
alled cristae. These folds increase the surface area available for chemical reactions.
The primary function of mitochondria is to generate large quantities of energy in the form of
 adenosine triphosphate (ATP). In addition to supplying cellular energy, mitochondria are involved 
in other tasks, such as signaling, cellular differentiation, and cell death, as well as maintaining 
the control of the cell cycle and cell growth.
  ...
  return (
    <div
      className="min-h-screen bg-black font-mono text-green-500 
    selection:bg-green-500 selection:text-black overflow-x-hidden"
    >
      ...
      rgba(0,255,0,0.02),rgba(0,0,255,0.06))] z-50 bg-[length:100%_2px,3px_100%]"
      ></div>
